const Services = () => {
  return (
    <div className="text-base text-textColor text-center md:text-left md:w-[90%]  flex w-full h-auto flex-col items-center justify-center">
      ...
      <span className="text-orange-600 space-y-5 text-[2.5rem] lg:text-[1.6rem]"><b> OUR SERVICE</b>
...
<span className="text-orange-600 space-y-5 text-[2.5rem] lg:text-[1.6rem]"><b> JOIN OUR NETWORK</b> <div className="space-y-5"></div> </span>
